...
// --> General settings
$hesk_settings['site_title']='Ouvidoria SMTT';
$hesk_settings['site_url']=rtrim(getenv('APP_URL') ?: 'http://localhost:8080', '/');
$hesk_settings['hesk_title']='Ouvidoria SMTT';
$hesk_settings['hesk_url']=rtrim(getenv('APP_URL') ?: 'http://localhost:8080', '/');
$hesk_settings['webmaster_mail']='informatica.smtt@socorro.se.gov.br';
$hesk_settings['site_theme']='hesk3';
$hesk_settings['admin_css']=1;
$hesk_settings['admin_css_url']='https://ouvidoria.smttsocorro.com.br/theme/csssmtt/smttsc.css';
...
// --> Database settings
$hesk_settings['db_host']=getenv('DB_HOST') ?: 'db';
$hesk_settings['db_name']=getenv('DB_NAME') ?: 'ouvidoria';
$hesk_settings['db_user']=getenv('DB_USER') ?: 'ouvidoria';
$hesk_settings['db_pass']=getenv('DB_PASSWORD') ?: 'troque-esta-senha';
$hesk_settings['db_pfix']='ouvidoria_';
...
$hesk_settings['attach_dir']='anexos';
$hesk_settings['cache_dir']='cache2';
...
$hesk_settings['debug_mode']=(int) (getenv('HESK_DEBUG') ?: 0);
$hesk_settings['short_link']=1;
...
$hesk_settings['secimg_sum']='Z1XDZ18RYT';
...
$hesk_settings['force_ssl']=(int) (getenv('FORCE_SSL') ?: 0);
$hesk_settings['url_key']=getenv('HESK_URL_KEY') ?: 'chave-local-troque-em-producao';
...
$hesk_settings['ticket_list']=array('trackid','dt','lastchange','category','name','subject','status','staffreplies','lastreplier','due_date','custom9');

// --> Other
$hesk_settings['submittedformat']=4;
$hesk_settings['updatedformat']=4;
$hesk_settings['format_submitted']='d-m-Y g:i a';
$hesk_settings['format_updated']='d-m-Y g:i a';


// ==> MISC

// --> Date & Time
$hesk_settings['timezone']='America/Bahia';
