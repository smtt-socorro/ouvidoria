...
$hesklang['name']='Nome (Caso não queira se identificar, por favor coloque um nome fantasia)';
...
$hesklang['how_can_we_help']='Olá, você está na ouvidoria da SMTT, como podemos lhe ajudar?';
...
$hesklang['help_desk']=''; // Displayed on staff sidebar menu
